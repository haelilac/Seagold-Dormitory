...
const Units = () => {
  ...
  if (loading) {
    return <div className="unit-spinner"></div>;
  }
        ...
        <div className="search-section">
          ...
          <div className="search-input" style={{ display: "flex", alignItems: "center" }}>
            <img
              ...
              onClick={() => handleFilterClick("availability", capacityInput.trim())}
                ...
                {Array.isArray(unit.images) && unit.images.length > 0 && (
                  <div className="carousel-container">
                    <button
                      ...
                      onClick={() => handleCarousel(unit.id, "prev", unit.images.length)}
                    >
                      &#8592;
                    </button>
                    <div
                      className="carousel-images"
                      style={{ transform: `translateX(-${(carouselIndices[unit.id] || 0) * 100}%)` }}
                    >
                    ...
                    <button
                      ...
                      onClick={() => handleCarousel(unit.id, "next", unit.images.length)}
                    >
                      &#8594;
                    </button>
                  </div>
